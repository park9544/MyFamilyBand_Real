...
public class IntroActivity extends AppCompatActivity {
        ...
        loginButton.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    if (!isConnected()) {
                        Toast.makeText(IntroActivity.this, "인터넷 연결을 확인해주세요", Toast.LENGTH_SHORT).show();
                    }
                }
    ...
    private class SessionCallback implements ISessionCallback {
        ...
        public void onSessionOpened() {
            //access token 을 성공적으로 발급 받아 valid access token 을 가지고 있는 상태. 일반적으로 로그인 후의 다음 activity 로 이동한다.
        ...
        UserManagement.requestLogout(new LogoutResponseCallback() {
            ...
            public void onCompleteLogout() {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(IntroActivity.this, "로그아웃 성공", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    private void requestMe() {
        ...
        UserManagement.requestMe(new MeResponseCallback() {
            ...
            public void onSuccess(final UserProfile userProfile) {
                ...
                profilePath = userProfile.getProfileImagePath();

                Log.e("userId", userId + "");
                Log.e("userName", userName);
                Log.e("profile", profilePath);
        ...
        SimpleMultiPartRequest smpr= new SimpleMultiPartRequest(Request.Method.POST, loadUserInfo, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response.equals("fail")){ // 중복값이 없다는 응답.
                    ...
                    SimpleMultiPartRequest smpr = new SimpleMultiPartRequest(Request.Method.POST, InsertURL,
                    ...
                    smpr.addStringParam("profileImg", profilePath);
